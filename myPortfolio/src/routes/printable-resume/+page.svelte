<svelte:head>
	<title>Austin B. Sanchez - Printable Resume</title>
	<meta name="description" content="Printable resume of Austin B. Sanchez - Entrepreneur, Filmmaker, Technical Professional" />
</svelte:head>
